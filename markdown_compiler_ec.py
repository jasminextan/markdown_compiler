...
def compile_italic_star(line):
    ...
    >>> compile_italic_star('*This is italic!* \*This is not italic!\* This is not italic (ec).')
    '<i>This is italic!</i> *This is not italic!* This is not italic (ec).'
    >>> compile_italic_star('\*This is not italic!\* *This is italic (ec)!*')
    '*This is not italic!* <i>This is italic (ec)!</i>'
    >>> compile_italic_star('This is *italic* (ec)! \*This is not italic!\*')
    'This is <i>italic</i> (ec)! *This is not italic!*'
